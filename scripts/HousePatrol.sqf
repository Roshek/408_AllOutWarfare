...
* STARTING POS - Some building positions doesnt work well will the setPos command. 
...
* DEBUG - Use markers and chatlog for mission design debugging.
	guard = [this,"SAFE",30, [], -1, true, "HIGH", true] execVM "HousePatrol.sqf" 	
...
_house 				= if (count _this > 7) then {_this select 7} else {nearestBuilding _unit};
